...
/**
 ** check97 - checks for the correct number of jobs
 ** @argc: number of job can function can do it
 **
 ** Return: void
 **/
 ...
 ** @check: checks if it true of false
 ** @file: file name
...
/**
 ** check100 - Check whether the file is locked properly or not
 ** @check: checks if it true or false
 ** @fd: file descriptor
 **
 ** Return: void
 **/
...
/**
 ** main - copy the file into another file
 ** @argc: number of arguments that passed
